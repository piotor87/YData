...
in this case from the subscribed group. In our scenario, we are also facing the issue of censorhsip, i.e. the presence of users whose death might be not observed yet. In Fig.\ref{fig:lifetimes} we can see practically what that means: while the red lines show a birth (subscription)
